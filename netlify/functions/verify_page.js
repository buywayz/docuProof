        ...
        <div id="rightLoaded" style="display:none;">
          ...
          <div id="shareSection" style="display:none;margin-top:16px;padding:16px;border:1px solid rgba(245,158,11,0.3);border-radius:12px;">
            ...
            <div class="share-buttons" id="shareButtons">
              ...
              <button class="share-btn" data-action="reddit" onclick="window._shareOpen(event,'reddit')">
              ...
              <button class="share-btn" data-action="whatsapp" onclick="window._shareOpen(event,'whatsapp')">
...
(function(){
  ...
  window._shareGo = function(page) {
    ...
    } else if (pendingAction === "reddit") {
      var redditUrl = "https://www.reddit.com/submit?url=" + encodeURIComponent(url) + "&title=" + encodeURIComponent(shareText);
      window.open(redditUrl, "_blank", "width=700,height=500");
    } else if (pendingAction === "whatsapp") {
      var waUrl = "https://wa.me/?text=" + encodeURIComponent(shareText + " " + url);
